...
exercise.concatenate = function(string1, string2, string3){
    ...
    // ----------------------------------------
    var conc = string1 + string2 + string3;
    return conc;
};
...
exercise.greaterThanSix = function(someNumbers){
    ...
    // ----------------------------------------
    var res = someNumbers
    .filter(function(someArray) {
      return(someArray > 6);
      // TODO your code here
    })
    .map(function(someArray) {
      return someArray;
      // TODO your code here
    });
...
//     peopleSalary = peopleSalary + people[i].salary;
// }
//     var salary = people.map(function(item) {
...
exercise.executeCallback = function(callback){
    ...
    // ----------------------------------------
    // var call = {};
    // callback.forEach(function(greeting) {
    // call[greeting] = greeting
    //   });
    return 'call';
};
